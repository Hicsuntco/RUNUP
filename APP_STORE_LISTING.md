...
```
RUNUP : Coach Course IA
```

## Sous-titre (30 caractères max)
```
Ton coach de course par IA
```

## Texte promotionnel (170 caractères max — modifiable à tout moment sans nouvelle review)
```
Un programme qui s'adapte après chaque sortie, un vrai coach IA qui te connaît, et tes anneaux d'activité. Cours comme si tu avais un coach.
```
...
RUNUP Premium débloque un coach IA sans limite, des stats avancées et des connexions illimitées à tes autres apps de santé.
...
```
course,running,coach,ia,entrainement,fractionné,cardio,santé,marathon,10km,semi,vma,plan,coureuse
```
